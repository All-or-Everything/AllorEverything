...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/.yarn/cache/lodash-npm-4.17.21-6382451519-eb835a2e51.zip/node_modules/lodash/lodash.js
var require_lodash = __commonJS({
  "pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/.yarn/cache/lodash-npm-4.17.21-6382451519-eb835a2e51.zip/node_modules/lodash/lodash.js"(exports, module2) {
    (function() {
      var undefined2;
      var VERSION = "4.17.21";
...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/main.ts
__export(exports, {
  default: () => ObsidianTweaksPlugin
});
var import_obsidian3 = __toModule(require("obsidian"));

// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/BetterFormatting.ts
var import_lodash2 = __toModule(require_lodash());

// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/Utils.ts
var import_lodash = __toModule(require_lodash());
function getMainSelection(editor) {
  return {
...
function selectionToRange(selection) {
  const sortedPositions = import_lodash.default.sortBy([selection.anchor, selection.head], "line", "ch");
  return {
    from: sortedPositions[0],
    to: sortedPositions[1]
  };
}
function selectionToLine(editor, selection) {
...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/BetterFormatting.ts
var _BetterFormatting = class {
  constructor(app, plugin) {
    this.app = app;
    this.plugin = plugin;
  }
  expandRangeByWords(editor, range, symbolStart, symbolEnd) {
    ...
    while (true) {
      ...
      const preChar = editor.getRange(newFrom2, from);
      const postChar = editor.getRange(to, newTo2);
      if (preChar === postChar) {
        break;
      }
      ...
      if (!_BetterFormatting.PRE_WIDOW_EXPAND_CHARS.includes(preChar)) {
        break;
      }
      from = newFrom2;
    }
    while (true) {
      ...
      if (!_BetterFormatting.POST_WIDOW_EXPAND_CHARS.includes(postChar)) {
        break;
      }
      to = newTo2;
    }
  ...
  wrap(editor, textRange, selection, symbolStart, symbolEnd) {
    ...
    const newSelection = import_lodash2.default.cloneDeep(selection);
    newSelection.anchor.ch += symbolStart.length;
    newSelection.head.ch += symbolEnd.length;
    return [changes, newSelection];
  }
  unwrap(editor, textRange, selection, symbolStart, symbolEnd) {
    const changes = [
      {
        from: textRange.from,
        to: {
  ...
  setSelectionWrapState(editor, selection, wrapState, symbolStart, symbolEnd) {
    const initialRange = selectionToRange(selection);
    const textRange = this.expandRangeByWords(editor, initialRange, symbolStart, symbolEnd);
  ...
  toggleWrapper(editor, view, symbolStart, symbolEnd) {
    if (symbolEnd === void 0) {
    ...
    for (const selection of selections) {
      const [changes, newSelection] = this.setSelectionWrapState(editor, selection, targetWrapState, symbolStart, symbolEnd);
...
var BetterFormatting = _BetterFormatting;
BetterFormatting.PRE_WIDOW_EXPAND_CHARS = "#$@";
BetterFormatting.POST_WIDOW_EXPAND_CHARS = "!?:";

// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/Constants.ts
var DEBUG_HEAD = "Obsidean Tweaks: ";

// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/Entities.ts
...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/DirectionalCopy.ts
var DirectionalCopy = class {
  constructor(app, plugin) {
    this.app = app;
    this.plugin = plugin;
  }
  directionalCopy(editor, view, direction) {
    const selections = editor.listSelections();
...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/DirectionalMove.ts
var DirectionalMove = class {
  constructor(app, plugin) {
    this.app = app;
    this.plugin = plugin;
  }
  directionalMove(editor, view, direction) {
    const selections = editor.listSelections();
    const changes = [];
    for (const selection of selections) {
      const range = selectionToRange(selection);
...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/FileHelper.ts
...
var FileHelper = class {
  ...
  duplicateFile(editor, view) {
    return __async(this, null, function* () {
      ...
      const selections = editor.listSelections();
      const newFilePath = activeFile.parent.path + "/" + activeFile.basename + " (copy)." + activeFile.extension;
      try {
        const newFile = yield this.app.vault.copy(activeFile, newFilePath);
        yield view.leaf.openFile(newFile);
  ...
  newAdjacentFile(editor, view) {
    return __async(this, null, function* () {
      ...
      try {
        const newFile = yield this.app.vault.create(newFilePath, "");
        yield view.leaf.openFile(newFile);
      } catch (e) {
        new import_obsidian.Notice(String(e));
      }
...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/SelectionHelper.ts
var SelectionHelper = class {
  constructor(app, plugin) {
    this.app = app;
    this.plugin = plugin;
  }
  selectLine(editor, view) {
    const selections = editor.listSelections();
    const newSelectionRanges = [];
    for (const selection of selections) {
  ...
  selectWord(editor, view) {
    var _a, _b, _c, _d;
    const selections = editor.listSelections();
    const newSelections = [];
    for (const selection of selections) {
      const range = selectionToRange(selection);
      const wordStart = (_b = (_a = editor.wordAt(range.from)) == null ? void 0 : _a.from) != null ? _b : range.from;
      const wordEnd = (_d = (_c = editor.wordAt(range.to)) == null ? void 0 : _c.to) != null ? _d : range.from;
      const newSelection = {
...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/Settings.ts
var import_obsidian2 = __toModule(require("obsidian"));
var DEFAULT_SETTINGS = {
  debug: false
};
var ObsidianTweaksSettingTab = class extends import_obsidian2.PluginSettingTab {
  constructor(app, plugin) {
    super(app, plugin);
    this.plugin = plugin;
  }
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Debug mode").setDesc("Whether to output debug logging to console").addToggle((toggle) => {
...
// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/ToggleHeading.ts
var import_lodash3 = __toModule(require_lodash());
var Heading = /* @__PURE__ */ ((Heading2) => {
  Heading2[Heading2["NORMAL"] = 0] = "NORMAL";
  Heading2[Heading2["H1"] = 1] = "H1";
  Heading2[Heading2["H2"] = 2] = "H2";
  Heading2[Heading2["H3"] = 3] = "H3";
  Heading2[Heading2["H4"] = 4] = "H4";
  Heading2[Heading2["H5"] = 5] = "H5";
  Heading2[Heading2["H6"] = 6] = "H6";
  return Heading2;
})(Heading || {});
var _ToggleHeading = class {
  constructor(app, plugin) {
    this.app = app;
    this.plugin = plugin;
  }
  setHeading(editor, heading, line) {
    const headingStr = "#".repeat(heading);
    const text = editor.getLine(line);
    const matches = _ToggleHeading.HEADING_REGEX.exec(text);
    const from = {
      line,
      ch: 0
    };
    ...
    const replacementStr = heading === 0 /* NORMAL */ ? "" : headingStr + " ";
    return {
      from,
      to,
      text: replacementStr
  ...
  getHeadingOfLine(editor, line) {
    const text = editor.getLine(line);
    const matches = _ToggleHeading.HEADING_REGEX.exec(text);
    return matches[1].length;
  }
  toggleHeading(editor, view, heading) {
    const selections = editor.listSelections();
    const mainSelection = getMainSelection(editor);
    const mainRange = selectionToRange(mainSelection);
    const mainHeading = this.getHeadingOfLine(editor, mainRange.from.line);
    const targetHeading = heading === mainHeading ? 0 /* NORMAL */ : heading;
    const changes = [];
    const linesToSet = import_lodash3.default.uniq(import_lodash3.default.flatten(selections.map((x) => {
      const range = selectionToRange(x);
      return import_lodash3.default.range(range.from.line, range.to.line + 1);
    })));
...
var ToggleHeading = _ToggleHeading;
ToggleHeading.HEADING_REGEX = /^(#*)( *)(.*)/;

// pnp:/home/runner/work/ObsidianTweaks/ObsidianTweaks/src/main.ts
var ObsidianTweaksPlugin = class extends import_obsidian3.Plugin {
  onload() {
    return __async(this, null, function* () {
