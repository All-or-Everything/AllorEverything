...
A self-interrogating, citizen-facing system of user edits, additions, and reviews that actively shapes the design of the governance system. Citizens decide how the societal framework is structured and changed over time through a commit and peer review process. This is based on the same secure Merkle-tree architecture as the likes of Git and blockchain. Any individual can edit the rules, structures, and processes that govern society and commit these edits as a proposal. This is then reviewed by others. The interface should be available via browser for both desktop and mobile use.
</details>

<details><summary><strong>Function</strong></summary>
Every commit proposal is subject to evaluation by other citizens, and comparison to other proposals. Everything can be rated and reviewed, including reviews. Users are assigned weighted variables reflecting the reliability of their proposals and feedback. These variables attribute reliability contextually and along multiple qualitative metrics. They include many different statistics, like consistency, observed bias, rating by others (accounting for others' reliability), reliability in ratings given to others, and other necessary variables. Everything relavent is tracked and accounted for.
Ratings and reviews are facilitated through structured interactions, with judgments and comparisons informing various user metrics which, in conjunction with the judgments and comparisons themselves, are used to ensure and maintain quality, accuracy, effectiveness, and overall utility of all proposals and feedback before they are accepted. A structured suite of feedback-engineered interfaces and environments allow users to review other users accurately. Through questions and environments framed precisely to address specific angles of any given proposal, this architecture improves detail while narrowing system uncertainty.
</details>

<details><summary><strong>Purpose</strong></summary>
Create a fully self-contained and self-regulated system of societal-scale political adaptation & innovation. Ensures policy is judged fairly and accurately while preventing bad policy from getting through. People's positions and roles in this decentralized digital network are constantly calibrated by structured user ratings so the network positively reinforces productive policy. Enables flexibility and direct user feedback on policy proposals
</details>
